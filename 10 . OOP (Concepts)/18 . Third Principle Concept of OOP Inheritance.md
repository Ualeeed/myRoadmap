...
- Inheritance is the principle of Object-Oriented Programming (OOP) that allows a **class (Sub/derived class)** to acquire the **properties and behaviors (fields and methods)** of another **class (super/base class)**.

- It helps in **code reusability** and establishes a **hierarchical relationship** between classes.
